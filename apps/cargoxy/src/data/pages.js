...
export const pages = [
  {
    ...
    features: [
      ...
      { t: 'AWB and HAWB from the job', d: 'Air waybills and house air waybills produced from the shipment record, with the details already in place, rather than filled into a template by hand.', i: 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM14 2v6h6M8 13h8M8 17h5' },
      { t: 'Dangerous goods declarations', d: 'Built-in DGD workflows for shipments moving under international air and ocean freight regulations, so compliance is part of the booking rather than a separate document chase.', i: 'M12 9v4m0 4h.01M10.3 3.9L1.8 18a2 2 0 001.7 3h17a2 2 0 001.7-3L13.7 3.9a2 2 0 00-3.4 0z' },
    ...
    faqs: [
      ...
      { q: 'Does it handle dangerous goods?', a: 'Yes, through built-in dangerous goods declaration workflows designed around international air and ocean freight regulations.' },
    ],
  },
  {
    slug: 'ocean',
    ...
    features: [
      ...
      { t: 'Master and house bills of lading', d: 'MBL and HBL documents generated digitally against the shipment record rather than a separate template, so the paperwork matches what was actually booked.', i: 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM14 2v6h6' },
      { t: 'Container bookings, tracked', d: 'FCL and LCL container bookings followed end to end, which is what NVOCCs and carriers need before they will move off a spreadsheet.', i: 'M2 20s2-1 4-1 3 1 6 1 4-1 6-1 4 1 4 1M4 18l1-6h14l1 6' },
    ...
    faqs: [
      ...
      { q: 'Do you issue both master and house bills of lading?', a: 'Yes, MBL and HBL are generated digitally against the shipment record, linked to the job rather than produced separately.' },
    ],
  },
  {
    slug: 'courier',
  ...
  },
  {
    ...
    features: [
      ...
      { t: 'Live tracking, no login required', d: 'Customers follow a shipment on a live tracking page without an account, while your team sees the full event history behind it. Most status calls stop arriving.', i: 'M12 8v4l3 3M12 22a10 10 0 110-20 10 10 0 010 20z' },
      { t: 'Role-based access control', d: 'Granular permissions per user, with audit logging, so who did what to which shipment is a record rather than a question.', i: 'M12 2l8 4v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V6l8-4z' },
      { t: 'Data isolation at the query layer', d: 'Separation is enforced where the data is read, not in the interface — the difference between a system that is private by design and one that is private by convention.', i: 'M4 4h7v7H4zM13 4h7v7h-7zM4 13h7v7H4zM13 13h7v7h-7z' },
      ...
      { t: 'Operations dashboard', d: 'Shipment volume, live status and revenue in one view — and profitability by shipment, customer and lane read from the same postings the daily work creates.', i: 'M4 19V9M10 19V5M16 19v-7M22 19H2' },
    ],
    faqs: [
      ...
      { q: 'Can customers raise their own bookings?', a: 'Yes, and they can follow shipment status on a live tracking page without needing a login at all.' },
      { q: 'How is our data kept separate from other companies?', a: 'Isolation is enforced at the query layer rather than in the interface, alongside role-based permissions and full audit logging.' },
    ],
  },
];
